...
<ControlStyle Height="30px" Width="70px"></ControlStyle>
            ...
            <asp:HyperLinkField HeaderText="查看原图" NavigateUrl="~/admin/ShowImage.aspx" Target="blank" Text="查看原图" DataNavigateUrlFormatString="~/4k/admin/ShowImage.aspx?imgUrl={0}" DataNavigateUrlFields="PayJpg" />
            <asp:TemplateField HeaderText="激活">
                <ItemTemplate>
                    <asp:Button ID="activate" runat="server" Text="激活" CommandName="Update"  />
                    &nbsp;
                    <asp:Button ID="failed" runat="server" Text="作废" CommandName="Delete" />
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
