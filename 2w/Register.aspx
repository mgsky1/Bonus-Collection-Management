          ...
          <div class="item">
           ...
           <div>电子邮箱：</div>
            <asp:TextBox ID="email" runat="server" CssClass="textbox"></asp:TextBox>
               <br />
               <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="电子邮箱不合法" ControlToValidate="email" ForeColor="Red" ValidationExpression="^[A-Za-z0-9\u4e00-\u9fa5]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$"></asp:RegularExpressionValidator>
        </div>
          </br>
        <div class="tijiao">
